  ...
  withLazySyntaxStyle(
    {
      ...
      removedBg: "#3a2230",
      contextBg: "#272535",
      addedContentBg: "#1f3835",
      removedContentBg: "#422835",
      contextContentBg: "#2e2c3c",
      addedSignColor: "#00ffaa",
      removedSignColor: "#ed91b1",
      lineNumberBg: "#1e1d28",
      lineNumberFg: "#888888",
      selectedHunk: "#454057",
      badgeAdded: "#00ffaa",
      ...
      noteBorder: "#CDC1FF",
      noteBackground: "#2d2a3e",
      noteTitleBackground: "#3a3552",
      noteTitleText: "#e0d4ef",
    },
    {
      default: "#dddddd",
      keyword: "#CDC1FF",
